...
// Script 12.6 - add_entry.php...Securing Query Data
/* This script adds a blog entry to a database. */
...
<form action="add_entry.php" method="post">
    <p>Entry Title: <input type="text" name="title" size="40" maxsize="100" value="<?php if (isset($_POST['title'])) {print htmlspecialchars($_POST['title']);} ?>" /></p>
    <p>Entry Text: <textarea name="entry" cols="40" rows="5"><?php if (isset($_POST['entry'])){print htmlspecialchars($_POST['entry']);} ?></textarea></p>
